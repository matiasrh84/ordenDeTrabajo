...
@Component
public class ModificaOrdenes extends javax.swing.JDialog {
    ...
    void cargarDatos() {
        ...
        if (idOrdenes != 0) {
            Orden orden = ordenService.findById(idOrdenes).get();
            if(orden.getLugar().equals("Taller")) {
                radioTaller.setSelected(true);
            } else {
                radioDomicilio.setSelected(true);
            }
            
            if(orden.getCondicion().equals("Facturar")) {
                radioFacturar.setSelected(true);
            } else {
            ...
            cboUsuario.setSelectedItem(orden.getUsuario());
    ...
    private void initComponents() {
        ...
        rSLabelTextIcon1.setText("Modifica órdenes");
